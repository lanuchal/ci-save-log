...
<script src="<?php echo base_url(); ?>assets/vendor/libs/datatable/js/dataTables.bootstrap5.min.js"></script>
<script src="<?php echo base_url(); ?>assets/vendor/libs/datatable/js/buttons.colVis.min.js"></script>
<!-- <script src="<?php echo base_url(); ?>assets/vendor/libs/datatable/js/dataTables.fixedHeader.min.js"></script> -->
<!-- <script src="<?php echo base_url(); ?>assets/vendor/libs/datatable/js/bootstrap.bundle.min.js"></script> -->
<script src="<?php echo base_url(); ?>assets/vendor/libs/datatable/js/dataTables.responsive.min.js"></script>
<script src="<?php echo base_url(); ?>assets/vendor/libs/datatable/js/buttons.bootstrap5.min.js"></script>
